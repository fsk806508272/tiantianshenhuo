	...
	<view class="k-scroll-view" ref="k-scroll-view" :style="[scrollContentStyle]" @touchstart="touchstart" @touchmove="touchmove"
	 @touchend="touchend" @touchcancel="touchcancel">
		...
		<view class="go-to-top-icon" v-if="old.scrollTop > 20" @tap="goTop">
			<!-- <text class="my-icons-custom icon-jiantou-up" style="color: red;font-size: 40rpx;"></text> -->
			<image class="topArrow_fsk" src="../../static/topArrow.png" mode=""></image>
		</view>
	...
	export default {
		...
		methods: {
			...
			checkTouch: function(moveY) {
				...
				// }
				// 下拉 并且在 顶部
				//  if (hk.touch_direction === 'bottom' && hk.isInTop) {
...
<style lang="scss" scoped>
	...
	.k-scroll-view {
		...
		.go-to-top-icon {
			...
			border-radius: 50%;
			box-shadow: 0 2rpx 10rpx 0 rgba(122,122,122,0.22);
			display: flex;
			justify-content: center;
			align-items: center;
			z-index: 9999;
